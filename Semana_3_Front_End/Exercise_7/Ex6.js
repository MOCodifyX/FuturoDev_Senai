...
function nomeSetor(setorFuncionario) {
...
console.log(`O funcionário, do setor ${nomeSetor(setorFuncionario)}, ${nomeFuncionario} teve ${horasTrabalhadas - horasExtras} horas trabalhadas e ${horasExtras} horas extras. Seu salário mensal foi de R$ ${salario.toFixed(2)}.`);
